...
def double_check(mass:int, running_count:int):
    if mass<=8:
        #print("returning",running_count)
        return running_count
    balance=mass//3-2
    running_count+=balance
    #print(balance)
    return double_check(balance, running_count)

for i in x:
    answer+=double_check(int(i),0)
